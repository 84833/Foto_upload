                ...
                <div class="card-body p-0">
                    <div class="row">
                        <div class="col-lg-6 d-none d-lg-flex">
                            <div class="flex-grow-1 bg-login-image" style="background-image: url(assets/img/dogs/img.png);"></div>
                        </div>
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <form action="login_verwerk.php" method="post" enctype="multipart/form-data" class="user">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="captcha_wrapper">
                                            <div class="g-recaptcha" data-sitekey="6LfLT-EZAAAAAFtsWbNwVzVH-i5h9NsRTFOkKjIr"></div>
                                        </div>
