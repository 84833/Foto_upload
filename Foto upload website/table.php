...
<head>
    ...
    <link rel="stylesheet" href="../Foto-upload2/assets1/bootstrap/css/bootstrap.min.css?h=31e0ce161befd2d04df6fb353d9c2d4d">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i">
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.12.0/css/all.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <link rel="stylesheet" href="../Foto-upload2/assets1/fonts/fontawesome5-overrides.min.css?h=28fcdefe8a87593f1f43b7d9951e0cba">
    <link rel="stylesheet" href="../Foto-upload2/assets1/css/styles.min.css?h=21a8a991eb151b3149005cd1d24faf0e">
</head>
    ...
    <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: rgb(6,126,150);">
        <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
            ...
            <ul class="navbar-nav text-light" id="accordionSidebar">
                ...
                <li class="nav-item"><a class="nav-link" href="profile.html"><i class="fa fa-image" style="color: rgb(255,255,255);"></i><span style="color: rgb(160,203,212);">Overzicht</span></a></li>
                <li class="nav-item"><a class="nav-link active" href="table.html"><i class="fas fa-upload" style="color: rgb(255,255,255);"></i><span style="color: rgb(160,203,212);">Upload</span></a></li>
    ...
    <div class="d-flex flex-column" id="content-wrapper">
        <div id="content">
            ...
            <div class="container-fluid">
                <h3 class="text-dark mb-4">Upload Pagina</h3>
            </div><!-- Start: Drag Drop File Input Upload -->
            <div class="files color form-group mb-3"><input type="file" multiple="" name="files"></div><!-- End: Drag Drop File Input Upload -->
        </div>
...
<script src="../Foto-upload2/assets1/js/script.min.js?h=4d952d21517087db850f0bbc41a815ca"></script>
</body>
