            ...
            <div class="tabel">
                ...
                if (mysqli_num_rows($resultaat) == 0) {
                    ...
                    while ($rij = mysqli_fetch_array($resultaat))
                    {
                        ...
                        $Bandzoeken = "SELECT image_url FROM Images  WHERE id";
                        echo "<td>" . "<img src = 'uploads/" . $rij['image_url'] . "' width='250px' height='250px'/>" . "</td>";
                        echo "<td>" . "" . "</td>";
                    }
...
<!--        </footer>-->
    ...
    <a class="border rounded d-inline scroll-to-top" href="#page-top" style="background: rgb(160,203,212);"><i class="fas fa-angle-up"></i></a>
</div>
